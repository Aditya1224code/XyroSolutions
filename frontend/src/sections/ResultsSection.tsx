    ...
    >
      <div className="px-6 lg:px-12">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p 
            className={`text-base md:text-lg text-gray-custom transition-all duration-700 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
        ...
        >
          {content.results.metrics.map((metric, index) => (
            ...
            >
              <p className="font-display font-bold text-5xl md:text-6xl lg:text-7xl text-dark mb-2">
                {metric.value}
              </p>
              <p className="text-gray-custom text-sm md:text-base">
                {metric.label}
              </p>
            </div>
          ))}
        ...
        {/* Testimonial */}
        <div 
          className={`bg-white rounded-2xl p-8 md:p-12 relative transition-all duration-700 ${
        ...
        >
          ...
          <blockquote className="font-display text-xl md:text-2xl lg:text-3xl text-dark leading-snug mb-6">
            "{content.results.testimonial.quote}"
          </blockquote>
          <cite className="not-italic text-gray-custom text-sm md:text-base">
