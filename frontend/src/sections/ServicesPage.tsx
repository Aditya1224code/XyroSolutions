  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 dark:from-[#050608] dark:to-[#0B0F14]">
      ...
      <div className="relative">
        ...
        {/* Hero Section */}
        <div className="pt-20 pb-8 px-6 lg:px-12 bg-gradient-to-br from-green-50 to-blue-50 dark:from-[#050608] dark:to-[#0B0F14]">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block px-4 py-2 bg-green-100 text-green-800 rounded-full text-sm font-medium mb-4 dark:bg-[#1E293B] dark:text-[#B8FF3D] dark:ring-1 dark:ring-white/10">
              Our Services
            </div>
